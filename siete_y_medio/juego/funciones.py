...
def report(num):
    if num == 2:
        ...
        form = 'select cardgame_id, max(ending_round_points-starting_round_points) from player_game_round where player_id = (select player_id from player where human = 0) and cardgame_id = cardgame_id group by 1;'
    elif num == 7:
